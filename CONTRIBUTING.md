...
[knowledge universe](https://github.com/SarfarazAhmedKhan/knowledge-universe) is [MIT](LICENSE) licensed and accepts contributions via GitHub pull requests. This document outlines some of the conventions on development workflow, commit message formatting, contact points and other resources to make it easier to get your contribution accepted.
...
- We prefer blog on topic of blockchain and if we like your blog we will publish it to our official website [knowledge universe.one](https://knowledge universe.one) and give the credit to you.
